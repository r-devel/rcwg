...
### Getting bug in R resolved
 ...
 - [5 current bugs](https://bugs.r-project.org/buglist.cgi?email1=coen.bernaards%40gmail.com&emailassigned_to1=1&emailcc1=1&emaillongdesc1=1&emailreporter1=1&emailtype1=substring&list_id=46267&order=Importance&query_format=advanced&resolution=---&resolution=FIXED&resolution=INVALID&resolution=NOT%20REPRODUCIBLE&resolution=SPAM&resolution=WONTFIX&resolution=Works%20as%20documented&resolution=WISHLIST&resolution=DUPLICATE&resolution=WORKSFORME&resolution=CONTRIBUTED%20PACKAGE&resolution=MOVED). First 2 are related and Coen has submitted patches for both.
