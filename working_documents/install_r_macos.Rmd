...
svn checkout https://svn.r-project.org/R/trunk/ "$TOP_SRCDIR"
    ...
    <details><summary><i>Alternatively checkout r-svn GitHub repo...</i></summary> You may prefer to use the <a href="https://github.com/r-devel/r-svn">r-svn GitHub repo</a>. Set the <code>TOP_SRCDIR</code> environment variable to the directory where you checkout the repository.
    </details>
