...
<details><summary>Note if you prefer to use an RStudio terminal</summary> The PATH setting in `~/.zprofile` will only work for a zsh terminal, so you may need to change your Global Options or add the PATH setting to `~/.bash_profile`
</details>
